...
public:
  XrdRedisRaftTalker(const RaftServer &srv, const RaftClusterID &id, const std::vector<RaftServer> &participants);
...
private:
  void setHandshake(const RaftClusterID &id, const std::vector<RaftServer> &participants);
